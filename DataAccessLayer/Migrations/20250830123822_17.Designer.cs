...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.EntityFrameWork.Tourlider", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EntityLayer.Concrate.Destiniton", b =>
                {
                    ...
                    b.Property<int>("Tourlidid")
                        .HasColumnType("int");

                    b.Property<int>("tourliderid")
                        .HasColumnType("int");

                    b.HasKey("DestinationID");

                    b.HasIndex("tourliderid");
            ...
            modelBuilder.Entity("EntityLayer.Concrate.Destiniton", b =>
                {
                    b.HasOne("DataAccessLayer.EntityFrameWork.Tourlider", "tourlider")
                        .WithMany("destinitons")
                        .HasForeignKey("tourliderid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("tourlider");
                });
            ...
            modelBuilder.Entity("EntityLayer.Concrate.User", b =>
                {
                    b.HasOne("DataAccessLayer.EntityFrameWork.Tourlider", null)
                        .WithMany("Users")
                        .HasForeignKey("Tourliderid");
                });
